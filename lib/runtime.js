...
exports.rawset(exports._G, 'setmetatable', function*(self, mt) {
	var selfType = exports.type(self), mtType = exports.type(mt)

	if(selfType != 'table')
		throw new Error('bad argument #1 to \'setmetatable\' (table expected, got ' + selfType + ')')

	if(mtType != 'table' && mtType != 'nil')
